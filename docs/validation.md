...
### L2 誤差評価（Richardson 外挿法）

電位分布 ψ(x) には解析解がないため、最密グリッド（N=6401）を参照解として L2 誤差を評価。

| N | σ誤差 [%] | L2誤差 [mV] | σ次数 | L2次数 |
|:---:|:---:|:---:|:---:|:---:|
| 51 | 36.85 | 0.270 | — | — |
| 101 | 13.94 | 0.075 | 1.40 | 1.85 |
| 201 | 3.95 | 0.018 | 1.82 | 2.03 |
| 401 | 1.00 | 0.0046 | 1.98 | 2.01 |
| 801 | 0.25 | 0.0011 | 2.01 | 2.02 |
| 1601 | 0.06 | 0.00027 | 2.01 | 2.07 |
| 3201 | 0.02 | 0.00005 | 2.01 | 2.32 |
...
Bikerman モデルも Standard PB と同様に **2次精度** を達成。
- 表面電荷: N ≥ 401 で誤差 1% 以下
- 電位分布: N ≥ 401 で L2 誤差 5 μV 以下
