...
ax1.annotate(f'Anode\n{phi_left_mV:+.0f} mV', xy=(0, phi_left_mV), xytext=(5, phi_left_mV-10), fontsize=8, color='red')
ax1.annotate(f'Cathode\n{phi_right_mV:+.0f} mV', xy=(100, phi_right_mV), xytext=(80, phi_right_mV+10), fontsize=8, color='blue')
...
x_right_pm = (100 - x_nm[mask_right]) * 1000
...
ax.axvline(x=100, color='blue', linewidth=3, label=f'Cathode ({phi_right_mV:+.0f} mV)')
