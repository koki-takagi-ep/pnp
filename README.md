...
| 量 | 定義 | 物理的意味 |
|---|---|---|
| Debye 長 | λ_D = √(εk_BT / 2e²c₀N_A) | 遮蔽長さ |
| 熱電圧 | φ_T = k_BT/e ≈ 25.7 mV (298 K) | 熱エネルギー |
| バルク濃度 | c₀ | 基準濃度 |
...
ここで κ = 1/λ_D は逆 Debye 長、φ_T = k_BT/e は熱電圧。
...
|-------------|------|-----------|------------------------|
| Debye 時間 | τ_D = λ_D²/D | EDL 局所緩和 | ~140 ps |
| RC 時定数 | τ_RC = λ_D·L/D | 表面電荷充電 | ~120 ns |
...
| テスト名 | c₀ [M] | φ₀ [mV] | L [nm] | ε_r | stretch | λ_D [nm] | L/λ_D | 収束次数 | 判定 |
|:---------|:------:|:-------:|:------:|:---:|:-------:|:--------:|:-----:|:--------:|:----:|
| baseline | 0.001 | 50 | 100 | 12 | 1.0 | 3.76 | 26.6 | 2.00 | PASS |
| c0_0.0001M | 0.0001 | 50 | 500 | 12 | 1.0 | 11.9 | 42.0 | 2.00 | PASS |
| c0_0.01M | 0.01 | 50 | 100 | 12 | 1.0 | 1.19 | 84.1 | 1.99 | PASS |
| c0_0.1M | 0.1 | 50 | 100 | 12 | 1.0 | 0.38 | 266 | 1.93 | PASS |
| phi_25mV | 0.001 | 25 | 100 | 12 | 1.0 | 3.76 | 26.6 | 2.00 | PASS |
| phi_100mV | 0.001 | 100 | 100 | 12 | 1.0 | 3.76 | 26.6 | 2.00 | PASS |
| phi_200mV | 0.001 | 200 | 100 | 12 | 1.0 | 3.76 | 26.6 | 1.85 | WARN |
| L_50nm | 0.001 | 50 | 50 | 12 | 1.0 | 3.76 | 13.3 | 1.92 | PASS |
| L_200nm | 0.001 | 50 | 200 | 12 | 1.0 | 3.76 | 53.2 | 2.00 | PASS |
| stretch_2.0 | 0.001 | 50 | 100 | 12 | 2.0 | 3.76 | 26.6 | 2.00 | PASS |
| stretch_3.0 | 0.001 | 50 | 100 | 12 | 3.0 | 3.76 | 26.6 | 1.99 | PASS |
| eps_80 | 0.001 | 50 | 300 | 80 | 1.0 | 9.71 | 30.9 | 1.99 | PASS |

**判定基準**: PASS (1.9 ≤ p ≤ 2.1), WARN (1.5 ≤ p < 1.9 or 2.1 < p ≤ 2.5), FAIL (otherwise)

#### 検証から得られた知見

1. **領域サイズの重要性**: L/λ_D ≥ 20〜30 で安定した2次精度を達成。短い領域ではバルク境界条件の影響で精度低下。

2. **高電位での収束**: φ₀ = 200 mV（~8k_BT/e）ではより細かいグリッドが必要。非線形性が強いため。

3. **非一様グリッドの効果**: stretch = 2〜3 でも2次精度を維持。界面付近の解像度向上に有効。

4. **高誘電率環境**: ε_r = 80（水系電解質）では λ_D が大きくなるため、それに応じた領域サイズが必要。
