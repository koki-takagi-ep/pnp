...
|:-----|----------:|------------:|------:|------------:|------:|
| 左端 (x = 0) | +100.0 | 20.4 | 0.020 | 49017 | 49.0 |
| バルク (x = L/2) | +50.0 | 1000.0 | 1.00 | 1000.0 | 1.00 |
| 右端 (x = L) | 0.0 | 49017 | 49.0 | 20.4 | 0.020 |

**物理的解釈**:

- 左電極（φ = +100 mV、バルク基準で+50 mV）: カチオン（EMI⁺）が排除され（c+/c₀ = 0.02）、アニオン（BF₄⁻）が蓄積（c-/c₀ = 49）
- 右電極（φ = 0 mV、バルク基準で-50 mV）: アニオン（BF₄⁻）が排除され（c-/c₀ = 0.02）、カチオン（EMI⁺）が蓄積（c+/c₀ = 49）
