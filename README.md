...
表面電位を0 mVから目標電位まで徐々に増加させ、各電位での定常状態EDL構造をアニメーションで可視化する。

<div align="center">

![EDL Evolution](results/edl_evolution.gif)

*図: 電圧スイープによるEDL形成アニメーション。左: 電位分布（青: 数値解、赤破線: Gouy-Chapman解析解）、右: イオン濃度分布（赤: カチオン、青: アニオン）。表面電位を徐々に増加させることで、EDLの発達過程を可視化。*
...
電位の増加に伴い、表面近傍でのカチオン排除とアニオン蓄積が顕著になり、電気二重層が発達する様子が観察できる。数値解はGouy-Chapman理論と良好に一致する。
